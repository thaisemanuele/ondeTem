...
/**
 * This class connects to the POI Web Server and sends xml notify file with the event
 * REVIEW only. It is necessary because review events are on the class RatingActivity.java
...
public class ReviewEventSend {
	...
	private static RatingActivity _activity;
	
	public void execute(RatingActivity activity) {
